...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'C:\Users\SAFI UDDIN\Desktop\face\Face-Recognition\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
